...
Simple CLI to compute areas of common shapes with input validation.

Usage:
  - Interactive: run without arguments and follow prompts.
  - Demo mode: run with --demo to print example outputs (non-interactive).

Shapes supported: circle, rectangle, square, triangle, trapezoid, ellipse
"""
