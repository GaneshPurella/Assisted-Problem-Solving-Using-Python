...
Interactive helper to compute the sum of squares.
Supports two input modes:
 - range: compute sum_{i=1..n} i^2 using formula
 - list: compute sum of squares of user-provided numbers (space or comma separated)

Usage:
  - Interactive: run without args and follow prompts
  - Demo: run with --demo to show example outputs
"""
...
def _build_cli():
    p = argparse.ArgumentParser(description="Sum of squares calculator (interactive or demo)")
