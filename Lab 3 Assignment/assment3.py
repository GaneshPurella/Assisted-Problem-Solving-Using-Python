...
Interactive wrapper for the TGNPDCL bill calculator.

Prompts the user for:
 - CU: previous meter reading
 - PU: present meter reading
 - or directly number of units (enter blank to use readings)
 - customer type (residential/commercial)

Computes EC, FC, CC, ED and prints the bill breakdown.

This file is intended as the student's submission file. It imports the
calculator implementation from `tgnpdcl_bill.py` (created alongside this file).
If you prefer a single-file submission, let me know and I'll merge them.
"""
